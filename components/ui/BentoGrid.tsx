...
export const BentoGridItem = ({
  ...
  const leftLists = ["Laravel", "CodeIgniter", "Mysql"];
  const rightLists = ["VueJS", "NuxtJS", "Tailwind"];
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        {icon}
        {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute top-0 right-2 lg:right-3">
              {/* tech stack lists */}
